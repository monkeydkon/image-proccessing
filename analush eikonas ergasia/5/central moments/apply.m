function [vec] = apply(Image)
    ...
    h5 = (u30-3*u12)*(u30+u12)*((u30+u12)^2-3*(u03+u21)^2) + (3*u21-u03)*(u03+u21)*(3*(u30+u12)^2 - (u03+u21)^2);
    h6 = (u20-u02)*((u30+u12)^2-(u03+u21)^2) + 4*u11*(u30+u12)*(u03+u21);
    h7 = (3*u21-u03)*(u30+u12)*((u30+u12)^2-3*(u03+u21)^2) - (u30-3*u12)*(u03+u21)*(3*(u30+u12)^2 - (u03+u21)^2);
